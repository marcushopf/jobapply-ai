...
Usage:
    ...
    python scripts/screen_jobs.py --candidate marcus_hopf

    # Search with custom query override
    python scripts/screen_jobs.py --candidate marcus_hopf --query "Senior Product Manager Berlin"

    # Add a job manually (paste URL or description)
    python scripts/screen_jobs.py --candidate marcus_hopf --manual
