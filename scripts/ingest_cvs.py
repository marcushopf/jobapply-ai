...
Usage:
    python scripts/ingest_cvs.py --name "Marcus Hopf" --cvs path/to/cv1.pdf path/to/cv2.pdf
...
def main():
    ...
    parser.add_argument("--name", required=True, help='Candidate full name, e.g. "Marcus Hopf"')
