...
Runs all 6 stages for a test candidate (Alex Müller) using the N26 job fixture.
...
class TestFullPipeline:
    ...
    def test_stage1_profile_extracted(self, test_base, sample_wishlist):
        ...
        profile = parse_profile_with_claude([(cv_path.name, text)], "Alex Müller")
    ...
    def test_stage3_gap_report_generated(self, test_base, n26_job):
        ...
        assert len(raw_gaps) > 0, "Expected gaps for Alex vs N26 job"
